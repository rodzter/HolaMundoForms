...
break;
 ...
 Sys_usuario oProducto = new Sys_usuario();
 //Nuevo OBJETO DE LA CLASE DAO_producto de la carpeta DAO
 DAO_usuario oProductoDAO = new DAO_usuario();
 ...
 oProducto.Usuario = this.txt_usuario.Text.Trim();
 oProducto.Contrasenia = this.txt_Contrasenia.Text.Trim();
 oProducto.Nombre_completo = this.txt_nombre.Text.Trim();
 oProducto.Tipo_usuario = this.txt_Tipo_usuario.Text.Trim();
