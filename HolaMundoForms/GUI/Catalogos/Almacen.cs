...
namespace HolaMundoForms.Catalogos
{
    public partial class Almacen : Form
    {
        ...
        public void ENVIAR_DATOS_NUEVO_REGISTRO()
        {
            ...
            Almacenes oProducto = new Almacenes();
            //Nuevo OBJETO DE LA CLASE DAO_producto de la carpeta DAO
            DAO_almacen oProductoDAO = new DAO_almacen();
            ...
            oProducto.Num_almacen = Convert.ToInt32(this.txt_num_almacen.Text);
            oProducto.Cod_producto = this.txt_cod_producto.Text.Trim();
            oProducto.Cantidad = (double)this.nud_Cantidad.Value;
            oProducto.Stock_minimo = (double)this.nud_Stock_Minimo.Value;
